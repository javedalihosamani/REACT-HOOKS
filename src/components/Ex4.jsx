...
const Ex4 = (props) => {
  ...
  const [productsItemPerPage, setProductsItemPerPage] = useState([]);
      ...
      <div className="container my-5">
        <div className="row">
          <div className="col text-center">
            <h5 className="display-3 text-danger">No Products.. Server error</h5>
          </div>
        </div>
      </div>
    )
    ...
    return(
      <Fragment>
        <div className="container my-5">
          <div className="row">
            <div className="col text-center">
              <h5 className="display-3">Products API Data</h5>
            </div>
          </div>
        </div>
        ...
        <div className="container my-5">
          <div className="row">
            {
              productsItemPerPage.map((product, index)=>{
                return(
